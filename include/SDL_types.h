...
enum {
	...
	SDL_RLEACCEL	= 0x00004000	, /* Surface is RLE encoded */
...
typedef struct SDL_Surface {
  ...
  void*               pixels;
  int				  offset;
  void*				  hwdata;/*	struct private_hwdata *hwdata; */
  SDL_Rect            clip_rect;         
  uint32_t				unused1;
  uint32_t				locked;
...
typedef int (*SDL_blit) (struct SDL_Surface* src, SDL_Rect* srect,struct SDL_Surface* dst, SDL_Rect* drect);
